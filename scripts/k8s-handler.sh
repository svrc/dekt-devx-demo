    ...
    "Statement": [
        {
            ...
            "Condition": {
                "StringEquals": {
                    "${OIDCPROVIDER}:sub": [ "system:serviceaccount:dev:default","system:serviceaccount:team:default","system:serviceaccount:application:default", "system:serviceaccount:brownfield-apis:default", "system:serviceaccount:scgw-system:default"],
                    "${OIDCPROVIDER}:aud": "sts.amazonaws.com"
                }
            }
        }
